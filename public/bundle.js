...
window.onload = function () {
  ...
  let what = ["ate my dinner", "peed on my foot", "crushed my car", "burned my hair"];
  let when = ["on my way home", "right in time", "when I finished cleaning", "right when I parked", "while I was praying"];
